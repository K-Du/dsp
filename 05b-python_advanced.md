...
>>  
```
{'Putt': [['Mary E. Putt', 'PhD ScD', 'Professor', 'mputt@mail.med.upenn.edu']], 'Feng': [['Rui Feng', 'Ph.D', 'AssistantProfessor', 'ruifeng@upenn.edu']], 'Bilker': [['Warren B. Bilker', 'Ph.D.', 'Professor', 'warren@upenn.edu']],
```
