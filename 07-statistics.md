...
>>
P(I|B) = P(B|I)P(I)/P(B)  
P(B) = P(B|I)P(I) + P(B|F)P(F) = 1(1/300) + (1/2)(1/125) = 11/1500  
P(I|B) = 1(1/300)/(11/1500) = 5/11  
>>
Answer is 5/11
...
>> A frequentist deals with only raw frequencies (probabilities) whereas a Bayesian considers prior knowledge as well. 
